...
class CreateResultadoCompetenciasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('resultado_competencias', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('resultado_competencias');
    }
}
