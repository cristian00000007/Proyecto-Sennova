                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Actualizar de Tipo Programa</h4>
                                </div>
                                <div class="card-body">
                                    <form class="needs-validation" method="POST" action="{{ route('actualizarBDTP') }}" novalidate>
                                        @csrf
                                        <div class="row g-1">
                                            <div>
                                                <input hidden name="id" value="{{ $updateTP->id }}">
                                            </div>
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="Tipo_Progra_Nombre">Tipo de Programa</label>
                                                <input type="text" class="form-control" name="Tipo_Progra_Nombre" id="Tipo_Progra_Nombre" value="{{ $updateTP->Tipo_Progra_Nombre }}" required>
                                                <div class="invalid-tooltip">El Tipo es Obligatorio.</div>
                                            </div>
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="Tipo_Progra_Estado">Estado</label>
                                                <input type="text" class="form-control" name="Tipo_Progra_Estado" id="Tipo_Progra_Estado" value="{{ $updateTP->Tipo_Progra_Estado }}" required>
