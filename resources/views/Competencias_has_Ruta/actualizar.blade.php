                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Actualizar Competecia Ruta</h4>
                                </div>
                                <div class="card-body">
                                    <form class="needs-validation" method="POST" action="{{ route('actualizarBDCDR') }}" novalidate>
                                        @csrf
                                        <div class="row g-1">
                                            <div>
                                            ...
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="resultadoCompetenciaId">Resultado</label>
                                                <select class="form-select" name="resultadoCompetenciaId" id="resultadoCompetenciaId" required>
                                                    @foreach ($verR as $info)
                                                    <option hidden></option>
                                                    <option value="{{ $info->id}}">{{ $info->Result_Nombre}}</option>
                                            ...
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="Detalle_Ruta_Estado">Competencia</label>
                                                <select class="form-select" name="CompetenciasId" id="CompetenciasId" required>
                                                    @foreach ($verC as $info)
                                                    <option hidden></option>
                                            ...
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="DetalleRutaId">Detalle</label>
                                                <select  class="form-select" name="DetalleRutaId" id="DetalleRutaId" required>
                                                    @foreach ($verD as $info)
                                                    <option hidden></option>
                                                    <option value="{{ $info->id}}">{{ $info->Detalle_Ruta_TemaPrincipal }}</option>
                                                    @endforeach
