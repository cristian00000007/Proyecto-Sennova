                ...
                <div class="auth-wrapper auth-cover">
                    <div class="auth-inner row m-0">
                        ...
                        <a class="brand-logo" href="#">
                            <h2 class="brand-text" style="color: rgb(22, 145, 38)">SENA</h2>
                        </a>
                        <!-- /Brand logo-->
                        <!-- Left Text-->
                            ...
                            <div class="width-700 mx-auto">
                                <div class="bs-stepper register-multi-steps-wizard shadow-none">
                                    ...
                                    <div class="bs-stepper-header px-0" role="tablist">
                                        ...
                                        <div >
                                            <a href="{{ route('registrarI') }}"><span style='font-family: "Gill Sans", sans-serif; font-size:20px; color:green;'>Aprendiz</span></a>
                                        </div>
                                        <div class="line">
                                        </div>
                                        <div >
                                    ...
                                    <div class="bs-stepper-content px-0 mt-4">
                                        <div id="account-details" class="content" role="tabpanel" aria-labelledby="account-details-trigger">
                                            ...
                                            <form action="{{ route('register') }}" method="POST" id="formularioregistro">
                                                @csrf
                                                <input id="rol" name="rol" value="Instructor" type="hidden">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 mb-1">
                                                        <label class="form-label" for="email">Email Alternativo</label>
                                            ...
                                            <form>
                                                <div class="row">
                                                    <div class="col-md-6 mb-1">
                                                        ...
                                                        <input type="number" name="cedula" id="cedula" class="form-control" placeholder="00000000" />
                                                    </div>
                                                    <div class="col-md-6 mb-1">
                                                        <label class="form-label" for="institucional">Email Institucional</label>
                                                        <input type="email" name="institucional" id="institucional" class="form-control" placeholder="john.doe@misena.edu.co" aria-label="john.doe" />
                                                    </div>
                                                    <div class="col-md-6 mb-1">
                                                        <label class="form-label" for="area">Area Tematica</label>
                                                        <select class="form-select" id="area" name="area">
                                                            @foreach ($areaTematica as $info)
                                                            <option value="{{ $info->id }}">{{ $info->Area_Tem_Nombre }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    <div class="col-md-6 mb-1">
                                                        <label class="form-label" for="tipoVinculacion">Tipo De Vinculacion</label>
                                                        <select class="form-select" id="tipoVinculacion" name="tipoVinculacion">
                                                            @foreach ($tipoVinculacion as $info)
