                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Actualizar Ruta Formacion</h4>
                                </div>
                                <div class="card-body">
                                    <form class="needs-validation" method="POST" action="{{ route('actualizarBDRF') }}" novalidate>
                                        @csrf
                                        <div class="row">
                                            <div>
                                                <input type="hidden" name="id" value="{{ $updateRutaf->id}}">
                                            </div>
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="Ruta_Nombre">Nombre</label>
                                                <input class="form-control" type="text" name="Ruta_Nombre" id="Ruta_Nombre" value="{{ $updateRutaf->Ruta_Nombre }}" required>
                                                <div class="invalid-tooltip">El Nombre es Obligatorio.</div>
                                            </div>
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="Ruta_Estado">Estado</label>
                                                <input class="form-control" type="text" name="Ruta_Estado" id="Ruta_Estado" value="{{ $updateRutaf->Ruta_Estado }}" required>
