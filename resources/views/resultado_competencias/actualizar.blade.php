                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Actualizar Resultados</h4>
                            </div>
                            <div class="card-body">
                                <form class="needs-validation" method="POST" action="{{ route('actualizarBDResultadoCompetencia')}}" novalidate>
                                    @csrf
                                    <div class="row">
                                        <div>
                                            <input type="hidden" name="id" value="{{ $updateR->id}}">
                                        </div>
                                        ...
                                        <div class="col-xl-6 col-md-6 col-12 position-relative">
                                            <label for="Result_Nombre">Nombre de Competencia</label>
                                            <input type="text" name="Result_Nombre" id="Result_Nombre" class="form-control" value="{{ $updateR->Result_Nombre }}" required>
                                            <div class="invalid-tooltip">El Nombre es Obligatorio.</div>
                                        </div>
                                        <div class="col-xl-6 col-md-6 col-12 position-relative">
                                            <label for="nombre_competencia">Resultado de Competencia</label>
                                            <input type="text" name="Result_Estado" id="Result_Estado" class="form-control" value="{{ $updateR->Result_Estado}}" required>
