                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Actualizar Instructor</h4>
                                </div>
                                <div class="card-body">
                                    <form class="needs-validation" method="POST" action="{{ route('actualizarBDInstructor') }}" enctype="multipart/form-data" novalidate>
                                        @csrf
                                        <div class="row">
                                            <div>
                                            ...
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                ...
                                                <input class="form-control" type="text" name="Instruct_Nombres" id="Instruct_Nombres" value="{{ $updateI->Instruct_Nombres }}" required>
                                                <div class="invalid-tooltip">El Nombre es Obligatorio.</div>
                                            </div>
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="Instruct_Apellidos">Apellido de Instructor</label>
                                                <input class="form-control" type="text" name="Instruct_Apellidos" id="Instruct_Apellidos" value="{{ $updateI->Instruct_Apellidos }}" required>
                                                <div class="invalid-tooltip">El Apellido es Obligatorio.</div>
                                            </div>
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="Instruct_EmailInstitucional">Correo Institucional</label>
                                                <input class="form-control" type="email" name="Instruct_EmailInstitucional" id="Instruct_EmailInstitucional" value="{{ $updateI->Instruct_EmailInstitucional }}" required>
                                                <div class="invalid-tooltip">El Correo es Obligatorio.</div>
                                            </div>
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="Instruct_EmailAlternativo">Correo Alternativo</label>
                                                <input class="form-control" type="email" name="Instruct_EmailAlternativo" id="Instruct_EmailAlternativo" value="{{ $updateI->Instruct_EmailAlternativo }}" required>
                                                <div class="invalid-tooltip">El Correo es Obligatorio.</div>
                                            </div>
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="Instruct_Celular">Numero de Celular</label>
                                                <input class="form-control" type="number" name="Instruct_Celular" id="Instruct_Celular" value="{{ $updateI->Instruct_Celular }}" required>
                                            ...
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                ...
                                                <input class="form-control" type="file" name="Instruct_Foto" id="Instruct_Foto" accept=".jpg, .png, .gif" value="{{ $updateI->Instruct_Foto }}">
                                            </div>
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="Instruct_Estado">Estado</label>
                                                <input class="form-control" type="text" name="Instruct_Estado" id="Instruct_Estado" value="{{ $updateI->Instruct_Estado }}" required>
