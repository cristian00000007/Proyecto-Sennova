                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Actualiazr Area Tematica</h4>
                                </div>
                                <div class="card-body">
                                    <form class="needs-validation" method="POST" action="{{ route('actualizarBDAT') }}" novalidate>
                                        @csrf
                                        <div class="row">
                                            <div>
                                            ...
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                ...
                                                <input class="form-control" type="text" name="Area_Tem_Nombre" id="Area_Tem_Nombre" value="{{ $updatePro->Area_Tem_Nombre }}" required>
                                                <div class="invalid-tooltip">El Nombre es Obligatorio.</div>
                                            </div>
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="CategAmbien_Estado">Estado</label>
                                                <input class="form-control" type="text" name="Area_Tem_Estado" id="Area_Tem_Estado" value="{{ $updatePro->Area_Tem_Estado }}" required>
