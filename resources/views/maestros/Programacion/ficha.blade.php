                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4>Programacion Ficha</h4>
                                </div>
                            </div>
                            <div class="row">
                            @foreach ($ficha as $fis)
                            <div class="col-md-4">
                            <div class="card" style="width: 18rem; background: grey;">
                                ...
                                <ul class="list-group list-group-flush">
                                    ...
                                    @if ($fis->id == $info->FichaId)
                                    <li class="list-group-item">{{ $info->Program_Franja }}</li>
                                    @endif
                                    @endforeach
                                </ul>
                            ...
                            <div class="card">
                                <div class="row">
                            @foreach ($programa as $as)
                            @if ($info->id == $as->FichaId)
                            <div class="col-md-4">
                            <div class="card-header">{{ $info->Ficha_Numero }}</div>
                            <div class="card-body">
                            <button class="btn btn-primary">{{ $as->Program_Franja }}</button>
