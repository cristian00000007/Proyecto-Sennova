                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4" id="fo{{ $ca->id }}">
                                        ...
                                        <div class="card text-center" style="width: 20rem; background: #fafafa;">
                                            <div class="card-body">
                                                <div id="carta{{ $ca->id }}" class="card" style="background: #cdffcf">
                                                    ...
                                                    <div id="ir{{ $ca->id }}">
                                                        {{-- <a type="submit" id="boton" class="btn btn-primary" name="id" href="{{ route('programacionAm','{{ $ca->id }}') }}">Revisar</a> --}}
                                                    </div>
...
@if ($info->ambientesIdAmbientes == $ca->id)
 ...
 var cr = document.getElementById('carta{{ $ca->id }}');
 console.log(cr);
 $('#ju{{ $ca->id }}').html('<small>Ocupado</small>');
 cr.style.background = '#FFC4C4';
 @endif
 @if ($tiempo != $info->Program_Franja)
 ...
 var ida = "{{ $ca->id }}";
 console.log(ida);
 var ur = "<a type='submit' id='boton' class='btn btn-primary' name='id' href='{{ route('programacionAm',"ida") }}'>Revisar</a>";
 ur = ur.replace('ida',ida);
 $('#ir{{ $ca->id }}').html(ur);
