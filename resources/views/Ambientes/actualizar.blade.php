                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Actualizar Ambiente</h4>
                                </div>
                                <div class="card-body">
                                    <form class="needs-validation" method="POST" action="{{ route('actualizarBDAm') }}" enctype="multipart/form-data" novalidate>
                                        @csrf
                                        <div class="row">
                                            <div>
                                                <input hidden name="id" value="{{ $updateAmbien->id }}">
                                            </div>
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="Ambien_Nombres">Nombre de Ambiente</label>
                                                <input class="form-control" type="text" name="Ambien_Nombres" id="Ambien_Nombres" value="{{ $updateAmbien->Ambien_Nombres }}" required>
                                                <div class="invalid-tooltip">El Nombre es Obligatorio.</div>
                                            </div>
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="Ambien_Capacidad">Capacidad de personas</label>
                                                <input class="form-control" type="number" name="Ambien_Capacidad" id="Ambien_Capacidad" value="{{ $updateAmbien->Ambien_Capacidad }}" required>
                                                <div class="invalid-tooltip">La Cantidad es Obligatoria.</div>
                                            </div>
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="Ambien_Foto">Foto de Ambiente</label>
                                                <input class="form-control" type="file" name="Ambien_Foto" id="Ambien_Foto" value="{{ $updateAmbien->Ambien_Foto }}">
                                            </div>
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="Ambien_Observacion">Observacion del Ambiente</label>
                                                <input class="form-control" type="text" name="Ambien_Observacion" id="Ambien_Observacion" value="{{ $updateAmbien->Ambien_Observacion }}" required>
                                                <div class="invalid-tooltip">La Observacion es Obligatoria</div>
                                            </div>
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="Ambien_Estado">Estado</label>
                                                <input class="form-control" type="text" name="Ambien_Estado" id="Ambien_Estado" value="{{ $updateAmbien->Ambien_Estado }}" required>
