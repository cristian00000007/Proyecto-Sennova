                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    @endforeach
                                    @foreach ($veri as $ref)
                                    <h4>Instructor: {{ $ref->Instruct_Nombres }}</h4>
                                    @endforeach
                                    @foreach ($verf as $refs)
                                    <h4>Instructor: {{ $refs->Ficha_Numero }}</h4>
                                    @endforeach
                                </div>
                            </div>
                        </div>
                ...
                <section id="basic-input" class="tooltip-validations">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Programacion de Ambiente</h4>
                                </div>
                                <div class="card-body">
                                    <div id="calendario">
                                        <h1>Calendario</h1>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
          ...
          var calendar = new FullCalendar.Calendar(calendarEl, {
            ...
            {
                title: 'Ocupado',
                start: '{{ $he->Program_Dia }}T06:00:00',
                end: '{{ $he->Program_Dia }}T12:00:00',
                display: 'background'
            },
            @endforeach
            ]
...
@foreach ($so as $ver)
@if ($ver->Program_Franja == 'Mañana')
<script>
    var tm = 12;
    for(var f=6; f<12; f++){
        var fl = document.getElementById('f'+[f]);
        fl.style.background = '#FFC4C4';
