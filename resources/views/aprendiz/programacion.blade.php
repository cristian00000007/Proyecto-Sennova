                    ...
                    <ul class="menu-content">
                        ...
                        <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i data-feather='clipboard'></i><span class="menu-title text-truncate" data-i18n="Pages">Fichas</span></a>
                            <ul class="menu-content">
                                ...
                                <li><a class="d-flex align-items-center" href="{{ route('@') }}"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="FAQ">Listado</span></a>
                                </li>
                            </ul>
                        </li>
...
<!-- END: Main Menu-->
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <h1>Aprendiz Programacion</h1>
                                </div>
                            </div>
                            <div class="row">
                                @foreach ($programf as $info)
                            <div class="col-md-6">

                                <div class="card text-center" style="width: auto; background: #ffffff;">
                                    <div class="card-body" id="cartap">
                                            <div class="card-body">
                                              <h4 class="card-title">Trimestre: {{ $info->Program_Trimestre }}</h4>
                                              <div>
                                                <div id="programa{{ $info->id }}" class="programa">
                                                    <button id="{{ $info->id }}" class="bton" onclick="quitar(this)">Cerrar</button>
                                                    <h3>Franja Horaria: {{ $info->Program_Franja }}</h3>
                                                    @foreach ($ambientes as $am)
                                                    @if ($info->ambientesIdAmbientes == $am->id )
                                                    <h3>Ambiente: {{ $am->Ambien_Nombres }}</h3>
                                                    @endif
                                                    @endforeach
                                                    @foreach ($fichav as $fe)
                                                    <h3>Ficha: {{ $fe->Ficha_Numero }}</h3>
                                                    @endforeach
                                                    @foreach ($instructor as $ins)
                                                    @if ($info->InstructorId  == $ins->id)
                                                    <h3>Instructor: {{ $ins->Instruct_Nombres }}</h3>
                                                    @endif
                                                    @endforeach
                                              ...
                                              <button id="{{ $info->id }}" class="btn btn-primary" onclick="ver(this)">ver</button>
                                            </div>
    ...
    <script>
        function ver(button){
            let ve = button.id;
            var pr = document.getElementById('programa'+ve);
            pr.style.display = "block";
        }
        function quitar(button){
            let ta = button.id;
            var pra = document.getElementById('programa'+ta);
