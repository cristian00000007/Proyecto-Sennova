                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="needs-validation" method="POST" action="{{ route('actualizarBDA')}}" novalidate enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <div>
                                        ...
                                        <div class="col-xl-4 col-md-6 col-12 position-relative">
                                            ...
                                            <input type="text" name="Aprend_Nombres" id="Aprend_Nombres" class="form-control" value="{{ $updateAprendiz->Aprend_Nombres }}" required>
                                            <div class="invalid-tooltip">El Nombre es Obligatorio.</div>
                                        </div>
                                        <div class="col-xl-4 col-md-6 col-12 position-relative">
                                            <label for="Aprend_Apellidos">Apellido de Aprendiz</label>
                                            <input type="text" name="Aprend_Apellidos" id="Aprend_Apellidos" class="form-control" value="{{ $updateAprendiz->Aprend_Apellidos }}" required>
                                            <div class="invalid-tooltip">El Apellido es Obligatorio.</div>
                                        </div>
                                        <div class="col-xl-4 col-md-6 col-12 position-relative">
                                            <label for="Aprend_Documento">Numero de Documento</label>
                                            <input type="number" name="Aprend_Documento" id="Aprend_Documento"  class="form-control" value="{{ $updateAprendiz->Aprend_Documento }}" required>
                                            <div class="invalid-tooltip">El Numero es Obligatorio.</div>
                                        </div>
                                        <div class="col-xl-4 col-md-6 col-12 position-relative">
                                            <label for="Aprend_Celular">Numero de Celular</label>
                                            <input type="number" name="Aprend_Celular" id="Aprend_Celular"  class="form-control" value="{{ $updateAprendiz->Aprend_Celular }}" required>
                                            <div class="invalid-tooltip">El Numero es Obligatorio.</div>
                                        </div>
                                        <div class="col-xl-4 col-md-6 col-12 position-relative">
                                            <label for="Aprend_Email">Email</label>
                                            <input type="email" name="Aprend_Email" id="Aprend_Email" class="form-control" value="{{ $updateAprendiz->Aprend_Email }}" required>
                                            <div class="invalid-tooltip">El Email es Obligatorio.</div>
                                        </div>
                                        <div class="col-xl-4 col-md-6 col-12 position-relative">
                                            <label for="Aprend_Foto">Foto</label>
                                            <input type="file" name="Aprend_Foto" id="Aprend_Foto" class="form-control" accept=".jpg, .png, .gif" value="{{ $updateAprendiz->Aprend_Foto }}">
                                        </div>
                                        <div class="col-xl-4 col-md-6 col-12 position-relative">
                                            <label for="Aprend_Estado">Estado</label>
                                            <input type="text" name="Aprend_Estado" id="Aprend_Estado"  class="form-control" value="{{ $updateAprendiz->Aprend_Estado }}" required>
