                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Actualizar Competencia</h4>
                                </div>
                                <div class="card-body">
                                    <form class="needs-validation" method="POST" action="{{ route('actualizarBDcompetencia') }}" novalidate>
                                        @csrf
                                        <div class="row">
                                            <div>
                                                <input type="hidden" name="id" value="{{ $updateCompetencia->id }}">
                                            </div>
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="Compet_Nombre">Nombre de Competencia</label>
                                                <input class="form-control" type="text" name="Compet_Nombre" id="Compet_Nombre" value="{{ $updateCompetencia->Compet_Nombre }}" required>
                                                <div class="invalid-tooltip">El Nombre es Obligatorio.</div>
                                            </div>
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="Compet_Horas">Horas de Competencia</label>
                                                <input class="form-control" type="number" name="Compet_Horas" id="Compet_Horas" value="{{ $updateCompetencia->Compet_Horas }}" required>
                                            ...
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                ...
                                                <input class="form-control" type="text" name="Compet_ConociProceso" id="Compet_ConociProceso" value="{{ $updateCompetencia->Compet_ConociProceso }}" required>
                                                <div class="invalid-tooltip">El Nombre es Obligatorio.</div>
                                            </div>
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="Compet_ConociSaber">Saber de Competencia</label>
                                                <input class="form-control" type="text" name="Compet_ConociSaber" id="Compet_ConociSaber" value="{{ $updateCompetencia->Compet_ConociSaber }}" required>
                                                <div class="invalid-tooltip">El Nombre es Obligatorio.</div>
                                            </div>
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="Compet_Criterios">Criterios de Competencia</label>
                                                <input class="form-control" type="text" name="Compet_Criterios" id="Compet_Criterios" value="{{ $updateCompetencia->Compet_Criterios }}" required>
                                                <div class="invalid-tooltip">El Nombre es Obligatoria.</div>
                                            </div>
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="Compet_Estado">Estado</label>
                                                <input class="form-control" type="text" name="Compet_Estado" id="Compet_Estado" value="{{ $updateCompetencia->Compet_Estado }}" required>
