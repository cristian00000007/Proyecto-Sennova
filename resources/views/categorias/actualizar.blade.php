                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Actualizar Categoria Ambiente</h4>
                                </div>
                                <div class="card-body">
                                    <form class="needs-validation" method="POST" action="{{ route('actualizarBDCa') }}" novalidate>
                                        @csrf
                                        <div class="row">
                                            <div>
                                                <input hidden name="id" value="{{ $updateCa->id }}">
                                            </div>
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="CategAmbien_Nombres">Nombre</label>
                                                <input class="form-control" type="text" name="CategAmbien_Nombres" id="CategAmbien_Nombres" value="{{ $updateCa->CategAmbien_Nombres }}" required>
                                                <div class="invalid-tooltip">El Nombre es Obligatorio.</div>
                                            </div>
                                            <div class="col-xl-4 col-md-6 col-12 position-relative">
                                                <label for="CategAmbien_Estado">Estado</label>
                                                <input class="form-control" type="text" name="CategAmbien_Estado" id="CategAmbien_Estado" value="{{ $updateCa->CategAmbien_Estado }}" required>
