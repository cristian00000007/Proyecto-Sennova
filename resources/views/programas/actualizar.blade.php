                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form class="needs-validation" method="POST" action="{{ route('actualizarBDPrograma') }}" novalidate>
                                    @csrf
                                    <div class="row">
                                        <div>
                                            <input type="hidden" name="id" value="{{ $updatePrograma->id}}">
                                        </div>
                                        <div class="col-xl-4 col-md-6 col-12 position-relative">
                                            <label for="Progra_Nombre">Nombre de Programa</label>
                                            <input type="text" class="form-control" name="Progra_Nombre" id="Progra_Nombre" value="{{ $updatePrograma->Progra_Nombre }}" required>
                                            <div class="invalid-tooltip">El Nombre es Obligatorio.</div>
                                        </div>
                                        <div class="col-xl-4 col-md-6 col-12 position-relative">
                                            <label for="Progra_Codigo">Codigo de Programa</label>
                                            <input type="text" class="form-control" name="Progra_Codigo" id="Progra_Codigo" value="{{ $updatePrograma->Progra_Codigo }}" required>
                                            <div class="invalid-tooltip">El Codigo es Obligatorio.</div>
                                        </div>
                                        <div class="col-xl-4 col-md-6 col-12 position-relative">
                                            <label for="Progra_Version">Version</label>
                                            <input type="text" class="form-control" name="Progra_Version" id="Progra_Version" value="{{ $updatePrograma->Progra_Version }}" required>
                                            <div class="invalid-tooltip">La Version es Obligatoria.</div>
                                        </div>
                                        <div class="col-xl-4 col-md-6 col-12 position-relative">
                                            <label for="Progra_TipoDuracion">Tipo de Duracion</label>
                                            <input type="text" class="form-control" name="Progra_TipoDuracion" id="Progra_TipoDuracion" value="{{ $updatePrograma->Progra_TipoDuracion }}" required>
                                            <div class="invalid-tooltip">El Tipo es Obligatorio.</div>
                                        </div>
                                        <div class="col-xl-4 col-md-6 col-12 position-relative">
                                            <label for="Progra_Duracion">Duracion</label>
                                            <input type="number" class="form-control" name="Progra_Duracion" id="Progra_Duracion" value="{{ $updatePrograma->Progra_Duracion }}" required>
                                            <div class="invalid-tooltip">La Duracion es Obligatoria.</div>
                                        </div>
                                        <div class="col-xl-4 col-md-6 col-12 position-relative">
                                            <label for="Progra_FechaRegistro">Fecha de registro</label>
                                            <input class="form-control" type="date" name="Progra_FechaRegistro" id="Progra_FechaRegistro" value="{{ $updatePrograma->Progra_FechaRegistro }}" required>
                                            <div class="invalid-tooltip">La Fecha es Obligatoria.</div>
                                        </div>
                                        <div class="col-xl-4 col-md-6 col-12 position-relative">
                                            <label for="Progra_Estado">Estado</label>
                                            <input type="text" class="form-control" name="Progra_Estado" id="Progra_Estado" value="{{ $updatePrograma->Progra_Estado }}" required>
                                        ...
                                        <div>
                                            <br>
                                            <button type="submit" id="registrar" class="btn btn-primary">ACTUALIZAR</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
